        ...
        <div className="grid gap-16 lg:grid-cols-[1.1fr_1fr] items-center">
          <div>
            ...
            <div className="mb-8 flex items-center gap-3">
              <a
                href="https://github.com/llm-net/adb-claw/releases/tag/v1.6.0"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <span className="font-mono text-sm font-semibold text-amber-500">v1.6.0</span>
            ...
            <div className="mt-10 flex items-center gap-3 rounded-lg border border-stone-800/60 bg-surface-900/50 px-4 py-2.5 max-w-lg">
              ...
              <span className="ml-auto text-[10px] text-stone-600 font-mono uppercase tracking-wider shrink-0">v1.6.0</span>
            </div>
          </div>
